# Run GA3B v0.3 top-level AXI-Stream smoke simulation with Vivado 2023.2.
...
& $xvlog -sv -f filelist_v03_top.f
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& $xelab tb_ga3b_heng_era_accel_top -s tb_ga3b_heng_era_accel_top_sim
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& $xsim tb_ga3b_heng_era_accel_top_sim -runall
exit $LASTEXITCODE
