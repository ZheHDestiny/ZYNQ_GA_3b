# Run additional pure3 resource-fit top-level AXI-Stream simulation with Vivado 2023.2.
...
& $xvlog -sv -f filelist_pure3_rf.f
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& $xelab tb_ga3b_pure3_rf_accel_top -s tb_ga3b_pure3_rf_accel_top_sim
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& $xsim tb_ga3b_pure3_rf_accel_top_sim -runall
exit $LASTEXITCODE
